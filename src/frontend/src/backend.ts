...
import type { ChatMessage as _ChatMessage, UserId as _UserId, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getChatMessagesForCaller(): Promise<Array<ChatMessage>> {
        if (this.processError) {
            try {
    ...
    async sendSupportMessage(arg0: string): Promise<void> {
        if (this.processError) {
            try {
...
function from_candid_record_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        adminReply: record_opt_to_undefined(from_candid_opt_n6(_uploadFile, _downloadFile, value.adminReply)),
        userId: value.userId,
        repliedAt: record_opt_to_undefined(from_candid_opt_n7(_uploadFile, _downloadFile, value.repliedAt)),
